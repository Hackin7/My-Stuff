...
<h2>Installation</h2>
<p><code>sh
$ npm install media-typer</code></p>
<h2>API</h2>
<p><code>js
var typer = require('media-typer')</code></p>
<h3>typer.parse(string)</h3>
<p><code>js
var obj = typer.parse('image/svg+xml; charset=utf-8')</code></p>
...
<p><code>js
var obj = typer.parse(req)</code></p>
...
<p><code>js
var obj = typer.parse(res)</code></p>
...
<p><code>js
var obj = typer.format({type: 'image', subtype: 'svg', suffix: 'xml'})</code></p>
