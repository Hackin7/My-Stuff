...
mime.extension('application/octet-stream');  // =&gt; 'bin'</code></p>
<h3>mime.charsets.lookup()</h3>
<p>Map mime-type to charset</p>
<p><code>js
mime.charsets.lookup('text/plain');        // =&gt; 'UTF-8'</code></p>
...
<p><code>js
mime.extension('text/x-some-format'); // =&gt; 'x-sf'</code></p>
<h3>mime.load(filepath)</h3>
<p>Load mappings from an Apache ".types" format file</p>
<p><code>js
mime.load('./my_project.types');</code>
