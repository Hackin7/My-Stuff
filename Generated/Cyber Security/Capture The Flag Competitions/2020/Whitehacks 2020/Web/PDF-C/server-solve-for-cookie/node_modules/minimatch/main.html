...
var mm = new Minimatch(pattern, options)</code></p>
<h3>Properties</h3>
<ul>
...
<p><code>javascript
var isJS = minimatch(file, "*.js", { matchBase: true })</code></p>
...
<p><code>javascript
var javascripts = fileList.filter(minimatch.filter("*.js", {matchBase: true}))</code></p>
...
<p><code>javascript
var javascripts = minimatch.match(fileList, "*.js", {matchBase: true}))</code></p>
