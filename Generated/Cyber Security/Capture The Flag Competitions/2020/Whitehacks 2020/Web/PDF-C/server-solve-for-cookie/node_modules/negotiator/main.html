...
<h2>Installation</h2>
<p><code>sh
$ npm install negotiator</code></p>
<h2>API</h2>
<p><code>js
var Negotiator = require('negotiator')</code></p>
<h3>Accept Negotiation</h3>
<p>```js
availableMediaTypes = ['text/html', 'text/plain', 'application/json']</p>
<p>// The negotiator constructor receives a request object
negotiator = new Negotiator(request)</p>
<p>// Let's say Accept header is 'text/html, application/*;q=0.2, image/jpeg;q=0.8'</p>
<p>negotiator.mediaTypes()
// -&gt; ['text/html', 'image/jpeg', 'application/*']</p>
<p>negotiator.mediaTypes(availableMediaTypes)
// -&gt; ['text/html', 'application/json']</p>
<p>negotiator.mediaType(availableMediaTypes)
// -&gt; 'text/html'
```</p>
...
<p>```js
negotiator = new Negotiator(request)</p>
<p>availableLanguages = ['en', 'es', 'fr']</p>
<p>// Let's say Accept-Language header is 'en;q=0.8, es, pt'</p>
<p>negotiator.languages()
// -&gt; ['es', 'pt', 'en']</p>
<p>negotiator.languages(availableLanguages)
// -&gt; ['es', 'en']</p>
<p>language = negotiator.language(availableLanguages)
// -&gt; 'es'
```</p>
...
<p>```js
availableCharsets = ['utf-8', 'iso-8859-1', 'iso-8859-5']</p>
<p>negotiator = new Negotiator(request)</p>
<p>// Let's say Accept-Charset header is 'utf-8, iso-8859-1;q=0.8, utf-7;q=0.2'</p>
<p>negotiator.charsets()
// -&gt; ['utf-8', 'iso-8859-1', 'utf-7']</p>
<p>negotiator.charsets(availableCharsets)
// -&gt; ['utf-8', 'iso-8859-1']</p>
<p>negotiator.charset(availableCharsets)
// -&gt; 'utf-8'
```</p>
...
<p>```js
availableEncodings = ['identity', 'gzip']</p>
<p>negotiator = new Negotiator(request)</p>
<p>// Let's say Accept-Encoding header is 'gzip, compress;q=0.2, identity;q=0.5'</p>
<p>negotiator.encodings()
// -&gt; ['gzip', 'identity', 'compress']</p>
<p>negotiator.encodings(availableEncodings)
// -&gt; ['gzip', 'identity']</p>
<p>negotiator.encoding(availableEncodings)
// -&gt; 'gzip'
```</p>
