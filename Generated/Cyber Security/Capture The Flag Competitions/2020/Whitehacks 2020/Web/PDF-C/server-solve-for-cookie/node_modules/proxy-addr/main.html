...
<p><code>sh
$ npm install proxy-addr</code></p>
<h2>API</h2>
<!-- eslint-disable no-unused-vars -->

<p><code>js
var proxyaddr = require('proxy-addr')</code></p>
...
proxyaddr(req, function (addr, i) { return i &lt; 1 })</code></p>
...
proxyaddr(req, ['127.0.0.0/255.0.0.0', '192.168.0.0/255.255.0.0'])</code></p>
...
<p><code>js
proxyaddr(req, '::1')
proxyaddr(req, ['::1/128', 'fe80::/10'])</code></p>
...
proxyaddr(req, ['loopback', 'fc00:ac:1ab5:fff::1/64'])</code></p>
<ul>
...
<p><code>js
proxyaddr.all(req, 'loopback')</code></p>
...
var addr = proxyaddr(req, trust)</code></p>
